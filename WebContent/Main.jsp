...
<table class="tg">
  <tr>
    ...
    <th class="tg-djtu"><a href="Operator.jsp" onclick="window.open(this.href, '_blank', 'width=1200px,height=600px,toolbars=no,scrollbars=no'); return false;">RoomsManagement</a></th>
