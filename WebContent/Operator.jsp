...
.tg .tg-6hdc{background-color:#000000;color:#000000;text-align:left;vertical-align:top}
...
.tg .tg-xy3e{background-color:#cb0000;color:#ffffff;border-color:inherit;text-align:center;vertical-align:top}
</style>
<table class="tg">
  <tr>
  ...
  <tr>
    <td class="tg-c3ow" colspan="7">Result_Table</td>
    <td class="tg-6hdc"></td>
  </tr>
  <tr>
